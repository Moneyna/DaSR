...
class BaseModel():
    ...
    def model_to_device(self, net):
        ...
        if self.opt['dist']:
            ...
            net = DistributedDataParallel(
                net, device_ids=[torch.cuda.current_device()], find_unused_parameters=find_unused_parameters,broadcast_buffers=False)
    ...
    def _print_different_keys_loading(self, crt_net, load_net, strict=True,ignore_keys=None):
        ...
        load_net_keys2 = set(load_net.keys())
    ...
    def load_network(self, net, load_path, strict=True, param_key='params',ignore_keys=None):
        """Load network.
        ...
        for k, v in deepcopy(load_net).items():
            if k.startswith('module.'):
                load_net[k[7:]] = v
                load_net.pop(k)
        self._print_different_keys_loading(net, load_net, strict,ignore_keys)
